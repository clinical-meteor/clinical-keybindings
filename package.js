...
Package.onUse(function(api) {
  ...
  api.addFiles('client/components/keybindingsModal/keybindingsModal.html',
    'client');
  api.addFiles('client/components/keybindingsModal/keybindingsModal.js',
    'client');
  api.addFiles('client/components/keybindingsModal/keybindingsModal.less',
    'client');
